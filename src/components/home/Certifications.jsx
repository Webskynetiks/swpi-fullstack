...
const certificates = [
  {
    src: '/Images/shanker-wire/awards/Awardimgone.png',
  },
  {
    src: '/Images/shanker-wire/awards/Awardimgtwo-scaled.png',
  },
  {
    src: '/Images/shanker-wire/awards/Awardimgthree.png',
  },

  {
    src: '/Images/shanker-wire/awards/Awardimgfour.png',
  },
  {
    src: '/Images/shanker-wire/awards/Awardimgfive.png',
  },
  {
    src: '/Images/shanker-wire/awards/Awardimgsix.png',
  },
  {
    src: '/Images/shanker-wire/awards/Awardimgseven.png',
  },
  {
    src: '/Images/shanker-wire/awards/Awardimgeight.png',
  },
  {
    src: '/Images/shanker-wire/awards/Awardimgnine.png',
  },
  {
    src: '/Images/shanker-wire/awards/Awardimgten.png',
  },
  {
    src: '/Images/shanker-wire/awards/Awardimgeleven.png',
  },
  {
    src: '/Images/shanker-wire/awards/Awardimgtweleve.png',
  },
];
  ...
  return (
    <section className="py-12 bg-gray-50">
      <div className="px-4 lg:px-10 mx-auto text-center">
        <h2 className="text-3xl font-bold text-[#3b4047] mb-8">Our <span className=''> Awards & </span>Appreciations
</h2>
